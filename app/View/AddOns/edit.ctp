                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            ...
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp;&nbsp;List Add-ons'), array('action' => 'index'), array('escape' => false)); ?></li>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <div class="thumbnail">
                            ...
                            src="<?= ($meal_img) ? $meal_img : 'http://placehold.it/100x100?text=image' ?>"
                            alt="meal">
                        </div>
