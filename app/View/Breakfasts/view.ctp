					...
					<div class="panel-heading">Actions</div>
						<div class="panel-body">
							<ul class="nav nav-pills nav-stacked">
									<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-edit"></span>&nbsp&nbsp;Edit Breakfast'), array('action' => 'edit', $breakfast['Breakfast']['id']), array('escape' => false)); ?> </li>
		<li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>&nbsp;&nbsp;Delete Breakfast'), array('action' => 'delete', $breakfast['Breakfast']['id']), array('escape' => false), __('Are you sure you want to delete # %s?', $breakfast['Breakfast']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-list"></span>&nbsp&nbsp;List Breakfasts'), array('action' => 'index'), array('escape' => false)); ?> </li>
		<li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp;New Breakfast'), array('action' => 'add'), array('escape' => false)); ?> </li>
...
<tr>
		...
		<td>
			<?php echo $this->Html->link($breakfast['Menu']['title'], array('controller' => 'menus', 'action' => 'view', $breakfast['Menu']['id'])); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($breakfast['Breakfast']['created']); ?>
			&nbsp;
		</td>
</tr>
<tr>
		...
		<td>
			<?php echo h($breakfast['Breakfast']['modified']); ?>
			&nbsp;
		</td>
</tr>
				</tbody>
...
<div class="related row">
	...
	<thead>
	<tbody>
	<?php foreach ($breakfast['Order'] as $order): ?>
		<tr>
