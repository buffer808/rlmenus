	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title strong" id="modalLabel">Smoked Garlic Longganisa</h4>
			</div>
									...
									<div class="row">
										<div class="col-sm-6">
											...
											<div class="h2 mt-0 form-group">
												<label class="small text-uppercase control-label" for="qty_order">Order Quantity</label>
												<input type="number" name="qty_order" id="qty_order" class="form-control input-lg" value="1" min="1" step="1" required="required">
											</div>
										</div>
										...
										<div class="col-sm-6">
												...
												<div class="h2 mt-0 mb-0 form-group">
													...
													<select id="add-on" class="form-control input-lg" required="required" name="add_on">
												...
												<div class="h2 mt-0 form-group">
													<label class="small text-uppercase control-label" for="qty_addon">Add-On Quantity</label>
													<input type="number" name="qty_addon" id="qty_addon" class="form-control input-lg" value="1" min="1" step="1" required="required">
												</div>

												<button type="submit" class="btn btn-warning btn-block btn-lg text-uppercase add-to-cart strong">
